...
export default function DynamicHero() {
  ...
  return (
    <section 
      ...
      style={{ 
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${heroContent.backgroundImage || heroBackground})` 
      }}
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-4 text-white/90" data-testid="hero-subtitle">
            {heroContent.subtitle}
          </p>
          <p className="text-lg mb-8 text-white/80 max-w-3xl mx-auto" data-testid="hero-description">
